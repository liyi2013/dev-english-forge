...
export function TopicCard({
  ...
  return (
    <Link
      ...
      className={cn("panel p-4 hover:border-primary/40 hover:shadow-sm transition group", className)}
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          {explainGoalZh && (
            <p className="text-xs text-muted-foreground/70 mt-0.5">{explainGoalZh}</p>
          )}
        </div>
